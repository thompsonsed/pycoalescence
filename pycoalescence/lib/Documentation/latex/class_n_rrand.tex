...
\item[\hyperlink{deprecated__deprecated000003}{Deprecated}]Obselete and possibly incorrect -\/ advise against use. \end{DoxyRefDesc}
\begin{DoxyReturn}{Returns}
the direction. 
\end{DoxyReturn}
...
\subsubsection[{\texorpdfstring{event(double probin)}{event(double probin)}}]{\setlength{\rightskip}{0pt plus 5cm}bool N\+Rrand\+::event (
\begin{DoxyParamCaption}
\item[{double}]{probin}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{class_n_rrand_a4a28ef1e508296a5a85b435f8005d9f7}{}\label{class_n_rrand_a4a28ef1e508296a5a85b435f8005d9f7}
...
{\em probin} & the event probability. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000001}{Deprecated}]This is the original version used in J Rosindell\textquotesingle{}s codebase, and has been altered for a version which approximates the gaussian distribution at extreme limits. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000002}{Deprecated}]Kept only for testing purposes. \end{DoxyRefDesc}
\begin{DoxyReturn}{Returns}
a random number drawn from the fat-\/tailed dispersal kernel. 
\end{DoxyReturn}
\index{N\+Rrand@{N\+Rrand}!i0@{i0}}
\index{i0@{i0}!N\+Rrand@{N\+Rrand}}
\subsubsection[{\texorpdfstring{i0(long max)}{i0(long max)}}]{\setlength{\rightskip}{0pt plus 5cm}long N\+Rrand\+::i0 (
\begin{DoxyParamCaption}
\item[{long}]{max}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{class_n_rrand_a68fb3474c8f51ef5c61adf2cc499c61c}{}\label{class_n_rrand_a68fb3474c8f51ef5c61adf2cc499c61c}
...
Normal distribution, with percentage chance to choose a uniform distribution instead. Note that this function will not produce the same output as \hyperlink{class_n_rrand_aa57a6e9bae94c2df5a00473ba6fa900d}{norm()} for the same parameters, even with a zero chance of picking from the uniform distribution (due to random number draws). 
...
\item[\hyperlink{todo__todo000001}{Todo}]add in warning for dispersal parameters that will take a massive amount of time. \end{DoxyRefDesc}
...
\item 
\hyperlink{_fattaildeviate_8h}{Fattaildeviate.\+h}\end{DoxyCompactItemize}
