...
.. _file_necsim_ConfigFileParser.cpp:
...
Contains implementation of the :ref:`file_necsim_ConfigFileParser.h` functions. 
...
Definition (``necsim/ConfigFileParser.cpp``)
--------------------------------------------
...
.. toctree::
   ...
   program_listing_file_necsim_ConfigFileParser.cpp.rst
