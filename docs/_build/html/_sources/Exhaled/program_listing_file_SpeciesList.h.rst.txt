...
.. code-block:: cpp
   ...
   public:
       ...
       {
   //      os << "deleted species index: " << index << " value: " << list[index] << " list size: " << list_size << endl;
           list[index] = 0;
           list_size --;
       ...
       void changePercentCover(unsigned long newmaxsize) // THIS NEEDS TO BE CHANGED TO TAKE ACCOUNT OF THE NEW REFERENCING METHOD
       {
   //      os << "1" << endl;
   ...
   //      os << "2" << endl;
   //      os << "templist.size: " << templist.size() << endl;
   //      os << "list.size: " << list.size() << endl;
   //      os << "list_size: " << list_size << endl;
   //      os << "maxsize: " << maxsize << endl;
   //      os << "newmaxsize: " << newmaxsize << endl;
   //      os << "templist[0]: " << templist[0] << endl;
   ...
   //          }
               ...
               // test new version
               unsigned long i = floor(rand_index);
               
               // REMOVE THIS LATER
               if(rand_index>maxsize)
               {
                   cerr << "ERROR IN INDEX" << endl;
                   string sam;
                   cin >> sam;
               }
               return list[i];
