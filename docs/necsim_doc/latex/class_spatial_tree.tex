...
\item 
\hyperlink{class_spatial_tree_a051cc56f4f1284c419616ca6b582d52f}{Spatial\+Tree} ()\hypertarget{class_spatial_tree_a051cc56f4f1284c419616ca6b582d52f}{}\label{class_spatial_tree_a051cc56f4f1284c419616ca6b582d52f}

\begin{DoxyCompactList}\small\item\em The constructor for \hyperlink{class_spatial_tree}{Spatial\+Tree}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Checks for resuming and prints to the terminal. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!apply\+Multiple\+Rates@{apply\+Multiple\+Rates}}
\index{apply\+Multiple\+Rates@{apply\+Multiple\+Rates}!Spatial\+Tree@{Spatial\+Tree}}
...
Speciation rates are read from the speciation\+\_\+rates object, which should have already been calculated. \index{Spatial\+Tree@{Spatial\+Tree}!apply\+Spec\+Rate@{apply\+Spec\+Rate}}
\index{apply\+Spec\+Rate@{apply\+Spec\+Rate}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!apply\+Spec\+Rate@{apply\+Spec\+Rate}}
\index{apply\+Spec\+Rate@{apply\+Spec\+Rate}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!apply\+Spec\+Rate\+Internal@{apply\+Spec\+Rate\+Internal}}
\index{apply\+Spec\+Rate\+Internal@{apply\+Spec\+Rate\+Internal}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!calc\+Speciation@{calc\+Speciation}}
\index{calc\+Speciation@{calc\+Speciation}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!check\+Output\+Directory@{check\+Output\+Directory}}
\index{check\+Output\+Directory@{check\+Output\+Directory}!Spatial\+Tree@{Spatial\+Tree}}
...
\end{DoxyReturn}
\index{Spatial\+Tree@{Spatial\+Tree}!check\+Proportion\+Added@{check\+Proportion\+Added}}
\index{check\+Proportion\+Added@{check\+Proportion\+Added}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{check\+Proportion\+Added(const double \&proportion\+\_\+added)}{checkProportionAdded(const double &proportion_added)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Tree\+::check\+Proportion\+Added (
\begin{DoxyParamCaption}
\item[{const double \&}]{proportion\+\_\+added}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_aa3eef7c7e66a975d1dfd1a0a0148e037}{}\label{class_tree_aa3eef7c7e66a975d1dfd1a0a0148e037}
...
\begin{DoxyParams}{Parameters}
{\em proportion\+\_\+added} & the proportion of lineages that should be added \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if the lineage should be added, false otherwise 
\end{DoxyReturn}
\index{Spatial\+Tree@{Spatial\+Tree}!check\+Sims@{check\+Sims}}
\index{check\+Sims@{check\+Sims}!Spatial\+Tree@{Spatial\+Tree}}
...
This version uses the default values read from the config file. \index{Spatial\+Tree@{Spatial\+Tree}!check\+Sims@{check\+Sims}}
\index{check\+Sims@{check\+Sims}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!check\+Sim\+Size@{check\+Sim\+Size}}
\index{check\+Sim\+Size@{check\+Sim\+Size}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!choose\+Random\+Lineage@{choose\+Random\+Lineage}}
\index{choose\+Random\+Lineage@{choose\+Random\+Lineage}!Spatial\+Tree@{Spatial\+Tree}}
...
The index of the random lineage is stored in this\+\_\+step, as chosen. Also records the required variables for the step process, like x, y position. \index{Spatial\+Tree@{Spatial\+Tree}!coalescence\+Event@{coalescence\+Event}}
\index{coalescence\+Event@{coalescence\+Event}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!complete\+Pause@{complete\+Pause}}
\index{complete\+Pause@{complete\+Pause}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{complete\+Pause(shared\+\_\+ptr$<$ ofstream $>$ out)}{completePause(shared_ptr< ofstream > out)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::complete\+Pause (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ofstream $>$}]{out}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_abea4ba1f5340f9690b92008a3b049fba}{}\label{class_tree_abea4ba1f5340f9690b92008a3b049fba}
...
\begin{DoxyParams}{Parameters}
{\em out} & the output stream to close up \\
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!convert\+Tip@{convert\+Tip}}
\index{convert\+Tip@{convert\+Tip}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{convert\+Tip(unsigned long i, double generationin, vector$<$ Tree\+Node $>$ \&data\+\_\+added)}{convertTip(unsigned long i, double generationin, vector< TreeNode > &data_added)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::convert\+Tip (
\begin{DoxyParamCaption}
\item[{unsigned long}]{i, }
\item[{double}]{generationin, }
\item[{vector$<$ {\bf Tree\+Node} $>$ \&}]{data\+\_\+added}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_a370a23cfb08fd27ed1862bdfa605c5b8}{}\label{class_tree_a370a23cfb08fd27ed1862bdfa605c5b8}
...
\hline
{\em data\+\_\+added} & vector of lineages to add to the data object \\
\hline
\end{DoxyParams}
...
\subsubsection[{\texorpdfstring{count\+Cell\+Expansion(const long \&x, const long \&y, const long \&xwrap, const long \&ywrap, const double \&generationin, vector$<$ Tree\+Node $>$ \&data\+\_\+added)}{countCellExpansion(const long &x, const long &y, const long &xwrap, const long &ywrap, const double &generationin, vector< TreeNode > &data_added)}}]{\setlength{\rightskip}{0pt plus 5cm}unsigned long Spatial\+Tree\+::count\+Cell\+Expansion (
\begin{DoxyParamCaption}
\item[{const long \&}]{x, }
\item[{const long \&}]{y, }
...
\item[{vector$<$ {\bf Tree\+Node} $>$ \&}]{data\+\_\+added}
\end{DoxyParamCaption}
)}\hypertarget{class_spatial_tree_a3e5e285241dbf1382e989624b1c77fed}{}\label{class_spatial_tree_a3e5e285241dbf1382e989624b1c77fed}
...
\hline
{\em data\+\_\+added} & vector containing \hyperlink{class_tree_node}{Tree\+Node} objects to add to data \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the number of lineages still to add 
\end{DoxyReturn}
\index{Spatial\+Tree@{Spatial\+Tree}!determine\+Speciation\+Rates@{determine\+Speciation\+Rates}}
\index{determine\+Speciation\+Rates@{determine\+Speciation\+Rates}!Spatial\+Tree@{Spatial\+Tree}}
...
Detects speciation rates from the config files supplied. \index{Spatial\+Tree@{Spatial\+Tree}!dump\+Active@{dump\+Active}}
\index{dump\+Active@{dump\+Active}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{dump\+Active(shared\+\_\+ptr$<$ ofstream $>$ out)}{dumpActive(shared_ptr< ofstream > out)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::dump\+Active (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ofstream $>$}]{out}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_a9cf1e86171d4a0e22e636bb2cdb01e27}{}\label{class_tree_a9cf1e86171d4a0e22e636bb2cdb01e27}
...
\begin{DoxyParams}{Parameters}
{\em out} & the output file stream to save the object to \\
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!dump\+Data@{dump\+Data}}
\index{dump\+Data@{dump\+Data}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{dump\+Data(shared\+\_\+ptr$<$ ofstream $>$ out)}{dumpData(shared_ptr< ofstream > out)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::dump\+Data (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ofstream $>$}]{out}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_aef421096d19ced6d699b84b90a0a5bbc}{}\label{class_tree_aef421096d19ced6d699b84b90a0a5bbc}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!dump\+Grid@{dump\+Grid}}
\index{dump\+Grid@{dump\+Grid}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{dump\+Grid(shared\+\_\+ptr$<$ ofstream $>$ out)}{dumpGrid(shared_ptr< ofstream > out)}}]{\setlength{\rightskip}{0pt plus 5cm}void Spatial\+Tree\+::dump\+Grid (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ofstream $>$}]{out}
\end{DoxyParamCaption}
)}\hypertarget{class_spatial_tree_abe47d47a37bf265337aeae602c65d8bb}{}\label{class_spatial_tree_abe47d47a37bf265337aeae602c65d8bb}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!dump\+Main@{dump\+Main}}
\index{dump\+Main@{dump\+Main}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{dump\+Main(shared\+\_\+ptr$<$ ofstream $>$ out)}{dumpMain(shared_ptr< ofstream > out)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::dump\+Main (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ofstream $>$}]{out}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_aa2af00092c1b4595e91b3443a9abad1a}{}\label{class_tree_aa2af00092c1b4595e91b3443a9abad1a}
...
\subsubsection[{\texorpdfstring{dump\+Map(shared\+\_\+ptr$<$ ofstream $>$ out)}{dumpMap(shared_ptr< ofstream > out)}}]{\setlength{\rightskip}{0pt plus 5cm}void Spatial\+Tree\+::dump\+Map (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ofstream $>$}]{out}
\end{DoxyParamCaption}
)}\hypertarget{class_spatial_tree_a38b7633da178a31a5279294928b7de09}{}\label{class_spatial_tree_a38b7633da178a31a5279294928b7de09}
...
\item[\hyperlink{deprecated__deprecated000010}{Deprecated}]this function is currently obselete and not implemented, but was still functional as of version 3.\+2\end{DoxyRefDesc}
\index{Spatial\+Tree@{Spatial\+Tree}!expand\+Cell@{expand\+Cell}}
\index{expand\+Cell@{expand\+Cell}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{expand\+Cell(long x, long y, long x\+\_\+wrap, long y\+\_\+wrap, double generation\+\_\+in, unsigned long add, vector$<$ Tree\+Node $>$ \&data\+\_\+added, vector$<$ Data\+Point $>$ \&active\+\_\+added)}{expandCell(long x, long y, long x_wrap, long y_wrap, double generation_in, unsigned long add, vector< TreeNode > &data_added, vector< DataPoint > &active_added)}}]{\setlength{\rightskip}{0pt plus 5cm}void Spatial\+Tree\+::expand\+Cell (
\begin{DoxyParamCaption}
\item[{long}]{x, }
\item[{long}]{y, }
\item[{long}]{x\+\_\+wrap, }
...
\item[{vector$<$ {\bf Tree\+Node} $>$ \&}]{data\+\_\+added, }
\item[{vector$<$ {\bf Data\+Point} $>$ \&}]{active\+\_\+added}
\end{DoxyParamCaption}
)}\hypertarget{class_spatial_tree_a5a6cf10d4f6d84d06091b07399a7abc7}{}\label{class_spatial_tree_a5a6cf10d4f6d84d06091b07399a7abc7}
...
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Cumulative\+Abundances@{get\+Cumulative\+Abundances}}
\index{get\+Cumulative\+Abundances@{get\+Cumulative\+Abundances}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{get\+Cumulative\+Abundances()}{getCumulativeAbundances()}}]{\setlength{\rightskip}{0pt plus 5cm}shared\+\_\+ptr$<$ vector$<$ unsigned long $>$ $>$ Tree\+::get\+Cumulative\+Abundances (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_ad84f38d8a8347b53c8fd77e0dc3e1f90}{}\label{class_tree_ad84f38d8a8347b53c8fd77e0dc3e1f90}
...
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Protracted@{get\+Protracted}}
\index{get\+Protracted@{get\+Protracted}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Protracted\+Generation\+Max@{get\+Protracted\+Generation\+Max}}
\index{get\+Protracted\+Generation\+Max@{get\+Protracted\+Generation\+Max}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Protracted\+Generation\+Min@{get\+Protracted\+Generation\+Min}}
\index{get\+Protracted\+Generation\+Min@{get\+Protracted\+Generation\+Min}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Protracted\+Variables@{get\+Protracted\+Variables}}
\index{get\+Protracted\+Variables@{get\+Protracted\+Variables}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Seed@{get\+Seed}}
\index{get\+Seed@{get\+Seed}!Spatial\+Tree@{Spatial\+Tree}}
...
Returns the seeds 
\end{DoxyReturn}
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Species\+Abundances@{get\+Species\+Abundances}}
\index{get\+Species\+Abundances@{get\+Species\+Abundances}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{get\+Species\+Abundances(const unsigned long \&community\+\_\+reference)}{getSpeciesAbundances(const unsigned long &community_reference)}}]{\setlength{\rightskip}{0pt plus 5cm}shared\+\_\+ptr$<$ map$<$ unsigned long, unsigned long $>$ $>$ Tree\+::get\+Species\+Abundances (
\begin{DoxyParamCaption}
\item[{const unsigned long \&}]{community\+\_\+reference}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_a3dafbfba14cf2a12a24ddd2c90bfd3fc}{}\label{class_tree_a3dafbfba14cf2a12a24ddd2c90bfd3fc}
...
\begin{DoxyParams}{Parameters}
{\em community\+\_\+reference} & the community reference \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\index{Spatial\+Tree@{Spatial\+Tree}!get\+Species\+Abundances@{get\+Species\+Abundances}}
\index{get\+Species\+Abundances@{get\+Species\+Abundances}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{get\+Species\+Abundances()}{getSpeciesAbundances()}}]{\setlength{\rightskip}{0pt plus 5cm}shared\+\_\+ptr$<$ vector$<$ unsigned long $>$ $>$ Tree\+::get\+Species\+Abundances (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_ac369b24b2b52b84b558220b9158806f8}{}\label{class_tree_ac369b24b2b52b84b558220b9158806f8}
...
the species abundances 
\end{DoxyReturn}
\index{Spatial\+Tree@{Spatial\+Tree}!has\+Paused@{has\+Paused}}
\index{has\+Paused@{has\+Paused}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!import\+Simulation\+Variables@{import\+Simulation\+Variables}}
\index{import\+Simulation\+Variables@{import\+Simulation\+Variables}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{import\+Simulation\+Variables(\+Config\+Parser config)}{importSimulationVariables(ConfigParser config)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::import\+Simulation\+Variables (
\begin{DoxyParamCaption}
\item[{{\bf Config\+Parser}}]{config}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_a43c8d5001964ac7dac4d55059ebc9b38}{}\label{class_tree_a43c8d5001964ac7dac4d55059ebc9b38}


Import the simulation variables from a Config\+Option. 
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!initiate\+Pause@{initiate\+Pause}}
\index{initiate\+Pause@{initiate\+Pause}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{initiate\+Pause()}{initiatePause()}}]{\setlength{\rightskip}{0pt plus 5cm}shared\+\_\+ptr$<$ ofstream $>$ Tree\+::initiate\+Pause (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_a3cd762da25ff2a313ccc21f4993918f5}{}\label{class_tree_a3cd762da25ff2a313ccc21f4993918f5}
...
\end{DoxyReturn}
\index{Spatial\+Tree@{Spatial\+Tree}!internal\+Setup@{internal\+Setup}}
\index{internal\+Setup@{internal\+Setup}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{internal\+Setup(shared\+\_\+ptr$<$ Sim\+Parameters $>$ sim\+\_\+parameters\+\_\+in)}{internalSetup(shared_ptr< SimParameters > sim_parameters_in)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::internal\+Setup (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ {\bf Sim\+Parameters} $>$}]{sim\+\_\+parameters\+\_\+in}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_a9bbc17547248e676085fab58ab2022e7}{}\label{class_tree_a9bbc17547248e676085fab58ab2022e7}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!load\+Grid\+Save@{load\+Grid\+Save}}
\index{load\+Grid\+Save@{load\+Grid\+Save}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{load\+Grid\+Save(shared\+\_\+ptr$<$ ifstream $>$ in1)}{loadGridSave(shared_ptr< ifstream > in1)}}]{\setlength{\rightskip}{0pt plus 5cm}void Spatial\+Tree\+::load\+Grid\+Save (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ifstream $>$}]{in1}
\end{DoxyParamCaption}
)}\hypertarget{class_spatial_tree_a5bf74321bb2ffdb8cf74a0a624aef7a8}{}\label{class_spatial_tree_a5bf74321bb2ffdb8cf74a0a624aef7a8}
...
\end{DoxyNote}
\index{Spatial\+Tree@{Spatial\+Tree}!load\+Map\+Save@{load\+Map\+Save}}
\index{load\+Map\+Save@{load\+Map\+Save}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{load\+Map\+Save(shared\+\_\+ptr$<$ ifstream $>$ in1)}{loadMapSave(shared_ptr< ifstream > in1)}}]{\setlength{\rightskip}{0pt plus 5cm}void Spatial\+Tree\+::load\+Map\+Save (
\begin{DoxyParamCaption}
\item[{shared\+\_\+ptr$<$ ifstream $>$}]{in1}
\end{DoxyParamCaption}
)}\hypertarget{class_spatial_tree_abbb3de8e0dbc9c08feb0d52882db5b66}{}\label{class_spatial_tree_abbb3de8e0dbc9c08feb0d52882db5b66}
...
\end{DoxyNote}
\index{Spatial\+Tree@{Spatial\+Tree}!make\+Tip@{make\+Tip}}
\index{make\+Tip@{make\+Tip}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{make\+Tip(const unsigned long \&tmp\+\_\+active, const double \&generation\+\_\+in, vector$<$ Tree\+Node $>$ \&data\+\_\+added)}{makeTip(const unsigned long &tmp_active, const double &generation_in, vector< TreeNode > &data_added)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::make\+Tip (
\begin{DoxyParamCaption}
\item[{const unsigned long \&}]{tmp\+\_\+active, }
\item[{const double \&}]{generation\+\_\+in, }
\item[{vector$<$ {\bf Tree\+Node} $>$ \&}]{data\+\_\+added}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_a3fa6fbeeb00d1661958f8e358796251c}{}\label{class_tree_a3fa6fbeeb00d1661958f8e358796251c}
...
\hline
{\em data\+\_\+added} & vector of lineages to add to data \\
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!output\+Data@{output\+Data}}
\index{output\+Data@{output\+Data}!Spatial\+Tree@{Spatial\+Tree}}
...
\item[\hyperlink{deprecated__deprecated000009}{Deprecated}]command line arguments are no longer supported. Function will be removed at next major update. \end{DoxyRefDesc}

\begin{DoxyParams}{Parameters}
{\em comargs} & \\
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!print\+Setup@{print\+Setup}}
\index{print\+Setup@{print\+Setup}!Spatial\+Tree@{Spatial\+Tree}}
...
This is stored in a separate function so that it can be called in isolation by child classes. \index{Spatial\+Tree@{Spatial\+Tree}!protracted\+Vars\+To\+String@{protracted\+Vars\+To\+String}}
\index{protracted\+Vars\+To\+String@{protracted\+Vars\+To\+String}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!run\+Simulation@{run\+Simulation}}
\index{run\+Simulation@{run\+Simulation}!Spatial\+Tree@{Spatial\+Tree}}
...
Setup is assumed to have been run already. This function is the main function containing the main loop of the simulation. At the end of the simulation, returns true if the simulation is complete, false otherwise. \index{Spatial\+Tree@{Spatial\+Tree}!set\+Object\+Sizes@{set\+Object\+Sizes}}
\index{set\+Object\+Sizes@{set\+Object\+Sizes}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!set\+Protracted\+Variables@{set\+Protracted\+Variables}}
\index{set\+Protracted\+Variables@{set\+Protracted\+Variables}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!set\+Resume\+Parameters@{set\+Resume\+Parameters}}
\index{set\+Resume\+Parameters@{set\+Resume\+Parameters}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!set\+Seed@{set\+Seed}}
\index{set\+Seed@{set\+Seed}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!set\+Sim\+Start\+Variables@{set\+Sim\+Start\+Variables}}
\index{set\+Sim\+Start\+Variables@{set\+Sim\+Start\+Variables}!Spatial\+Tree@{Spatial\+Tree}}
...
This is not the main set-\/up routine, which creates the permanent data structures including maps, the coalescence tree and active lineage listings. \index{Spatial\+Tree@{Spatial\+Tree}!setup@{setup}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!setup\+Community@{setup\+Community}}
\index{setup\+Community@{setup\+Community}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{setup\+Community()}{setupCommunity()}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Protracted\+Speciation\+Parameters} Tree\+::setup\+Community (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_ae39208e0f31a0170414a80e2b2d4e400}{}\label{class_tree_ae39208e0f31a0170414a80e2b2d4e400}


Sets up \hyperlink{class_community}{Community} member to point to the same output database as the simulation. 

\begin{DoxyReturn}{Returns}
the protracted speciation parameters to set up 
\end{DoxyReturn}
\index{Spatial\+Tree@{Spatial\+Tree}!setup\+Community\+Calculation@{setup\+Community\+Calculation}}
\index{setup\+Community\+Calculation@{setup\+Community\+Calculation}!Spatial\+Tree@{Spatial\+Tree}}
\subsubsection[{\texorpdfstring{setup\+Community\+Calculation(long double sr, double t)}{setupCommunityCalculation(long double sr, double t)}}]{\setlength{\rightskip}{0pt plus 5cm}void Tree\+::setup\+Community\+Calculation (
\begin{DoxyParamCaption}
\item[{long double}]{sr, }
\item[{double}]{t}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inherited]}}\hypertarget{class_tree_aaa85f6886029ee48472241cab746ded1}{}\label{class_tree_aaa85f6886029ee48472241cab746ded1}
...
\index{Spatial\+Tree@{Spatial\+Tree}!speciate\+Lineage@{speciate\+Lineage}}
\index{speciate\+Lineage@{speciate\+Lineage}!Spatial\+Tree@{Spatial\+Tree}}
...
\index{Spatial\+Tree@{Spatial\+Tree}!speciation@{speciation}}
\index{speciation@{speciation}!Spatial\+Tree@{Spatial\+Tree}}
...
\hline
\end{DoxyParams}
\index{Spatial\+Tree@{Spatial\+Tree}!sql\+Output@{sql\+Output}}
\index{sql\+Output@{sql\+Output}!Spatial\+Tree@{Spatial\+Tree}}
...
This function should not be called if the database is already opened on disc, and won\textquotesingle{}t do anything if it is. \index{Spatial\+Tree@{Spatial\+Tree}!stop\+Simulation@{stop\+Simulation}}
\index{stop\+Simulation@{stop\+Simulation}!Spatial\+Tree@{Spatial\+Tree}}
...
\item 
necsim/Spatial\+Tree.\+h\item 
necsim/Spatial\+Tree.\+cpp\end{DoxyCompactItemize}
