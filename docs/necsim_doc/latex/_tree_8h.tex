...
\begin{DoxyCompactList}\small\item\em Main simulation class for performing a non-\/spatial neutral simulation and generating the phylogenetic tree of the individuals. \end{DoxyCompactList}\end{DoxyCompactItemize}
